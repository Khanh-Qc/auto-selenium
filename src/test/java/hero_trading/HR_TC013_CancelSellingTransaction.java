...
public class HR_TC013_CancelSellingTransaction extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC013_CancelSellingTransaction() {
        log.info("----------HT_TC013_STEPS_01");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC013_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        //--------------------------------------------------------------------------------------
        log.info("----------HT_TC013_STEPS_02");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC013_STEPS_02();
        ...
        log.info("----------HT_TC013_STEPS_03");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC013_STEPS_03();

        log.info("----------HT_TC013_STEPS_04");
        sellPage.HT_TC013_STEPS_04();
        ...
        log.info("----------HT_TC013_STEPS_05");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC013_STEPS_05();
        ...
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC013_STEPS_06(priceSell);
        ...
        log.info("----------HT_TC013_STEPS_07");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC013_STEPS_07();
        ...
        log.info("----------HT_TC013_STEPS_08");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC013_STEPS_08();
        ...
        log.info("----------HT_TC013_STEPS_09");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC013_STEPS_09();
