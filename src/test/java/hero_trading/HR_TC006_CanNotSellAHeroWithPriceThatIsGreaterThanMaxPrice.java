...
public class HR_TC006_CanNotSellAHeroWithPriceThatIsGreaterThanMaxPrice extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC006_CanNotSellAHeroWithPriceThatIsGreaterThanMaxPrice() {
        log.info("----------HT_TC006_STEPS_01");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC006_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        log.info("----------HT_TC006_STEPS_02");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC006_STEPS_02();
        ...
        log.info("----------HT_TC006_STEPS_03");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC006_STEPS_03();

        log.info("----------HT_TC006_STEPS_04");
        sellPage.HT_TC006_STEPS_04();
        ...
        log.info("----------HT_TC006_STEPS_05");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC006_STEPS_05();

        log.info("Step : clickToSellButton");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        basePage.clickToSellButton();

        String priceSell = "100000";
        log.info("----------HT_TC006_STEPS_06");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC006_STEPS_06(priceSell);
        ...
        log.info("----------HT_TC006_STEPS_07");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC006_STEPS_07();

        log.info("Step : verifyTextErrorMessage");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        basePage.verifyTextErrorMessage("The maximum selling price is 99999.99 THC");

        log.info("----------HT_TC006_STEPS_08");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC006_STEPS_08();

        log.info("Step : checkSellNowButtonDisabled");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.checkSellNowButtonDisabled();
