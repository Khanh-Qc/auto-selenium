...
public class HR_TC015_StopSellingAHeroUnsuccessfullyBecauseOfNotEnoughBNBForGasFee extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC015_StopSellingAHeroUnsuccessfullyBecauseOfNotEnoughBNBForGasFee() {
        log.info("----------HT_TC015_STEPS_01");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        log.info("----------HT_TC015_STEPS_02");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_02();

        log.info("----------HT_TC015_STEPS_03");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_03();
        ...
        log.info("----------HT_TC015_STEPS_04");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_04();

        log.info("----------HT_TC015_STEPS_05");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_05();
        ...
        log.info("----------HT_TC015_STEPS_06");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_06();

        log.info("Step : clickToStopSellingButton");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        basePage.clickToStopSellingButton();

        log.info("----------HT_TC015_STEPS_07");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_07();
...
//        metamaskPage.verifyTextErrorNotHaveEnoughBNB();
        ...
        log.info("----------HT_TC015_STEPS_08");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_08();
        ...
        log.info("----------HT_TC015_STEPS_09");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC015_STEPS_09();
