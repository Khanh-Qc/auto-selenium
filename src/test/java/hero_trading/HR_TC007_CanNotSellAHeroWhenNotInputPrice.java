...
public class HR_TC007_CanNotSellAHeroWhenNotInputPrice extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC007_CanNotSellAHeroWhenNotInputPrice() {
        log.info("----------HT_TC007_STEPS_01");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC007_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        log.info("----------HT_TC007_STEPS_02");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC007_STEPS_02();
        ...
        log.info("----------HT_TC007_STEPS_03");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC007_STEPS_03();

        log.info("----------HT_TC007_STEPS_04");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC007_STEPS_04();
        ...
        log.info("----------HT_TC007_STEPS_05");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC007_STEPS_05();

        log.info("Step : clickToSellButton");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        basePage.clickToSellButton();

        log.info("----------HT_TC007_STEPS_06");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC007_STEPS_06();
        ...
        log.info("----------HT_TC007_STEPS_07");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC007_STEPS_07();
