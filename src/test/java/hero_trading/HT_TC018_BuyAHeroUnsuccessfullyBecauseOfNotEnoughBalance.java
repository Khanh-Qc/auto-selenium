...
public class HT_TC018_BuyAHeroUnsuccessfullyBecauseOfNotEnoughBalance extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HT_TC018_BuyAHeroUnsuccessfullyBecauseOfNotEnoughBalance() {
        log.info("----------HT_TC018_STEPS_01");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_01();
        ...
        log.info("----------HT_TC018_STEPS_02");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_02();

        log.info("----------HT_TC018_STEPS_03");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_03();
        ...
        log.info("----------HT_TC018_STEPS_04");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_04();

        log.info("----------HT_TC018_STEPS_05");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_05();
...
//        System.out.println("priceBuyHero: " + PRICE_BUY_HERO);
        ...
        log.info("----------HT_TC018_STEPS_06");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_06();
        ...
        log.info("----------HT_TC018_STEPS_07");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_07();

        log.info("Step : clickToBuyButton");
        basePage.clickToBuyButton();

        log.info("----------HT_TC018_STEPS_08");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_08();

        log.info("----------HT_TC018_STEPS_09");
        buyPage = PageGeneratorManager.getPageGenerator().getBuyPage(driver);
        buyPage.HT_TC018_STEPS_09();

        log.info("Step : verifyTextErrorMessagePopupCheckOut");
        basePage.verifyTextErrorMessagePopupCheckOut();
    }
