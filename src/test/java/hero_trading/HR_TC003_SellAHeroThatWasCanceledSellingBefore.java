...
public class HR_TC003_SellAHeroThatWasCanceledSellingBefore extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC003_SellAHeroThatWasCanceledSellingBefore() {
        log.info("----------HT_TC003_STEPS_01");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        log.info("----------HT_TC003_STEPS_02");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_02();
        ...
        System.out.println("------------current path: " + pathSell);
        ...
        // -----------------------cancel---------------------------
        log.info("----------HT_TC003_STEPS_03");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_03();
        ...
        log.info("----------HT_TC003_STEPS_04");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_04();

        log.info("----------HT_TC003_STEPS_05");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_05();

        log.info("Step : getPathPageUriHero");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        String pathSell_2 = basePage.getPathPageUriHero();
        System.out.println("------------current path: " + pathSell_2);

        log.info("----------HT_TC003_STEPS_06");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_06();

        log.info("Step : clickToSellButton");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        basePage.clickToSellButton();

        String priceSell_2 = "300";
        log.info("----------HT_TC003_STEPS_07");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_07(priceSell_2);

        log.info("Step : inputSellTextBox");
        sellPage.inputSellTextBox(priceSell_2);

        log.info("Step : getTextServiceFee");
        String FEE_THC_2 = sellPage.getTextServiceFee();
        System.out.println("FEE_THC: " + FEE_THC_2);

        log.info("----------HT_TC003_STEPS_08");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_08();
        ...
        log.info("----------HT_TC003_STEPS_09");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_09();
        ...
        log.info("----------HT_TC003_STEPS_10");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_10();
        ...
        // --------------------------------------------------
        log.info("----------HT_TC003_STEPS_11");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_11();

        log.info("----------HT_TC003_STEPS_12");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_12();

        log.info("----------HT_TC003_STEPS_13");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_13();
        ...
        sellPage.checkSellHeroExistPageBuy(pathSell_2);

        log.info("Step : priceSellHero");
        sellPage.checkPriceSellDisplayedExistPageBuy(priceSell_2);
        ...
        log.info("----------HT_TC003_STEPS_14");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_14();

        log.info("----------HT_TC003_STEPS_15");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_15();

        log.info("Step : checkSellHeroExistPageInventory");
        inventoryPage =  PageGeneratorManager.getPageGenerator().getInventoryPage(driver);
        inventoryPage.checkSellHeroExistPageInventory(pathSell_2);

        log.info("Step : clickToAvatarProfile");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        basePage.clickToAvatarProfile();

        log.info("----------HT_TC003_STEPS_16");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC003_STEPS_16();
