...
public class HR_TC005_CanNotSellAHeroWithPriceThatIsLessThanMinPrice extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC005_CanNotSellAHeroWithPriceThatIsLessThanMinPrice() {
        log.info("----------HT_TC005_STEPS_01");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC005_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        log.info("----------HT_TC005_STEPS_02");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC005_STEPS_02();
        ...
        log.info("----------HT_TC005_STEPS_03");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC005_STEPS_03();

        log.info("----------HT_TC005_STEPS_04");
        sellPage.HT_TC005_STEPS_04();
        ...
        log.info("----------HT_TC005_STEPS_05");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC005_STEPS_05();
        ...
        String priceSell = "99";
        log.info("----------HT_TC005_STEPS_06");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC005_STEPS_06(priceSell);
        ...
        log.info("----------HT_TC005_STEPS_07");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC005_STEPS_07();

        log.info("Step : clickToCancelButton");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        basePage.verifyTextErrorMessage("The minimum selling price is 100.00 THC");

        log.info("----------HT_TC005_STEPS_08");
        sellPage = PageGeneratorManager.getPageGenerator().getSellPage(driver);
        sellPage.HT_TC005_STEPS_08();
