...
public class HR_TC007_CanNotRentOutAHeroWhenUncheckingTheConfirmCheckBox extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC007_CanNotRentOutAHeroWhenUncheckingTheConfirmCheckBox() {
        log.info("----------HR_TC007_STEPS_01");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        //--------------------------------------------------------------------------------------
        log.info("----------HR_TC007_STEPS_02");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_02();
        ...
        log.info("----------HR_TC007_STEPS_03");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_03();

        log.info("----------HR_TC007_STEPS_04");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_04();
...
//        String battles = basePage.getTextBattles();
        ...
        log.info("----------HR_TC007_STEPS_05");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_05();

        log.info("Step : clickToRentButton");
        basePage.clickToRentButton();

        log.info("----------HR_TC007_STEPS_06");
        String battlesForRent = "50";
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_06(battlesForRent);

        log.info("Step : getTextBattlesForRent");
        rentPage.getTextBattlesForRent(battlesForRent);

        String rentPrice = "100";
        log.info("----------HR_TC007_STEPS_07");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_07(rentPrice);

        log.info("Step : inputRentTextBox");
        rentPage.inputPriceForRent(rentPrice);

        log.info("----------HR_TC007_STEPS_08");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_08();

        log.info("----------HR_TC007_STEPS_09");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC007_STEPS_09();
