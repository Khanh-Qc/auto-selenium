...
public class HR_TC010_CancelRentOutTransaction extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC010_CancelRentOutTransaction() {
        log.info("----------HR_TC010_STEPS_01");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_01();
...
//        log.info("Step : clickToAssetsButtonWeb");
        ...
        //--------------------------------------------------------------------------------------
        log.info("----------HR_TC010_STEPS_02");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_02();
        ...
        log.info("----------HR_TC010_STEPS_03");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_03();

        log.info("----------HR_TC010_STEPS_04");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_04();
        ...
        log.info("----------HR_TC010_STEPS_05");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_05();

        log.info("Step : clickToRentButton");
        basePage.clickToRentButton();

        log.info("----------HR_TC010_STEPS_06");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_06(battlesCurrent);
        ...
        log.info("----------HR_TC010_STEPS_07");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_07(rentPrice);

        log.info("Step : inputRentTextBox");
        rentPage.inputPriceForRent(rentPrice);

        log.info("----------HR_TC010_STEPS_08");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_08();

        log.info("Step : clickCheckBoxRent");
        rentPage.clickCheckBoxRent();

        log.info("----------HR_TC010_STEPS_09");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_09();
        ...
        log.info("----------HR_TC010_STEPS_10");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_10();

        log.info("Step : switchToMarketplaceWeb");
        metamaskPage.switchToMarketplaceWeb();

        log.info("----------HR_TC010_STEPS_11");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC010_STEPS_11();

        log.info("Step : verifyTextErrorMessagePopup");
        basePage.verifyTextErrorMessagePopup();
