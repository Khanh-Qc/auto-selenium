...
public class HR_TC013_CancelStopRentingAHero extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC013_CancelStopRentingAHero() {
        log.info("----------HR_TC013_STEPS_01");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC013_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        //--------------------------------------------------------------------------------------
        log.info("----------HR_TC013_STEPS_02");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC013_STEPS_02();
        ...
        log.info("----------HR_TC013_STEPS_03");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC013_STEPS_03();

        log.info("----------HR_TC013_STEPS_04");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC013_STEPS_04();

        log.info("Step : clickTotHeroItemSelectRent");
        inventoryPage =  PageGeneratorManager.getPageGenerator().getInventoryPage(driver);
        inventoryPage.clickTotHeroItemSelectStatusRent();
        ...
        log.info("----------HR_TC013_STEPS_05");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC013_STEPS_05();

        log.info("Step : clickToStopSellingButton");
        basePage = PageGeneratorManager.getPageGenerator().getBasePage(driver);
        basePage.clickToCancelRentingButton();

        log.info("----------HR_TC013_STEPS_06");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC013_STEPS_06();

        log.info("Step : clickToCancelRentingButtonPopup");
        basePage.clickToCancelRentingButtonPopup();
        ...
        log.info("----------HR_TC013_STEPS_07");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC013_STEPS_07();
        ...
        log.info("----------HR_TC013_STEPS_08");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC013_STEPS_08();
