...
public class HR_TC008_VerifyTheTransactionFeeCalculatedCorrectly extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void HR_TC008_VerifyTheTransactionFeeCalculatedCorrectly() {
        log.info("----------HR_TC008_STEPS_01");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC008_STEPS_01();
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        //--------------------------------------------------------------------------------------
        log.info("----------HR_TC008_STEPS_02");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC008_STEPS_02();
        ...
        log.info("----------HR_TC008_STEPS_03");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC008_STEPS_03();

        log.info("----------HR_TC008_STEPS_04");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC008_STEPS_04();
...
//        String battles = basePage.getTextBattles();
        ...
        log.info("----------HR_TC008_STEPS_05");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC008_STEPS_05();

        log.info("Step : clickToRentButton");
        basePage.clickToRentButton();

        String rentPrice = "100";
        log.info("----------HR_TC008_STEPS_06");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC008_STEPS_06(rentPrice);

        log.info("Step : inputRentTextBox");
        rentPage.inputPriceForRent(rentPrice);

        log.info("----------HR_TC008_STEPS_07");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC008_STEPS_07();

        log.info("----------HR_TC008_STEPS_08");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC008_STEPS_08();

        log.info("Step : feeTHCRentOutHero");
        rentPage.feeTHCRentOutHero();
