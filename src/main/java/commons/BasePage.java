...
//		System.out.println("Item size: " + allItems.size());
	...
	public String compareText(String xpathCurrently, String xpathLocator){
		if (xpathLocator.equals(xpathCurrently)){
			System.out.println("Status is correctly" + xpathCurrently);
			return xpathCurrently;
		}else {
			System.out.println("Xpath locator is: " + xpathLocator + "\n" + "XpathCurrently is: " + xpathCurrently );
			return xpathLocator;
		}
	}
